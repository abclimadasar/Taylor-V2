...
conn.sendFile(m.chat, global.API('https://picsum.photos/' + two + '/' + three), '', caption, m)
}
if (one == 'unsplash.it') {
conn.sendFile(m.chat, global.API('https://unsplash.it/' + two + '/' + three + '?random'), '', caption, m)
}
if (one == 'random.imagecdn.app') {
conn.sendFile(m.chat, global.API('https://random.imagecdn.app/' + two + '/' + three), '', caption, m)
}
        } catch (e) {
            throw eror
        }
